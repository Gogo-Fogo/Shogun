...
public class FullProjectDeepExportTool
{
    ...
    static void WriteDirectory(string dir, StreamWriter writer, string indent)
    {
    ...
    static void DumpGameObject(Transform t, StringBuilder writer, int indent)
    {
